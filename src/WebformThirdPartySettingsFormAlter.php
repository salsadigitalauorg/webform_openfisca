...
class WebformThirdPartySettingsFormAlter extends WebformFormAlterBase {
  ...
  public function alterForm(array &$form, FormStateInterface $form_state): void {
    ...
    $form['third_party_settings']['webform_openfisca']['fisca_session_ttl_seconds'] = [
      ...
      '#description' => $this->t("How long calculation results are retained in the user's session and exposed via the <code>[webform_openfisca:wo_session:@id:&lt;key&gt;]</code> token. Default: 14400 (4 hours). Set to 0 to disable session persistence.", ['@id' => $webform->id()]),
  ...
  public function validateForm(array $form, FormStateInterface $form_state): void {
    ...
    if ($enabled) {
      $this->messenger->addWarning(
        $this->t("Please be aware that submission data is automatically saved in Drupal unless this feature is disabled. Based on your use case, you'll need to consider the privacy implications of your webform and may need to disable saving of submissions.")
      );
    }
